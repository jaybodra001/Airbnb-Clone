...
//Below Map is imported in different way :)
// import Map from "../Map";
...
const RentModal = () => {
  //To keep track of what step we are on
  const [step, setStep] = useState(STEPS.CATEGORY);

  //Loading state
  const [isLoading, setIsLoading] = useState(false);

  //To contral modal state (Open Close isOpen etc...)
  ...
  //Dynamic Secondary action label
  ...
  if (step === STEPS.INFO) {
    bodyContent = (
      <div className="flex flex-col gap-8">
        <Heading title="Share some basics about your place" subtitle="What ameneties do you have?" />
